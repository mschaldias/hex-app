...
function add_button(list_id){
    ...
    `<li class="list-group-item list-group-item-action list-group-item-hex text-white draggable" id = "item{{item.id}}">
        <div class = "input-group mx-auto">
            ...
            <textarea id = "textarea" value = "{{item.text}}" name = "edit{{item.id}}" class = "form-control bg-hex-topnav border border-hex text-white" onchange="edit_text(name,value)"></textarea>
