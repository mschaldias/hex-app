...
urlpatterns = [
    ...
    path("task_modal/<int:id>",views.task_modal_template, name = "task_modal_template"),
    path("hex_streak/",views.hex_streak, name = "hex_streak"),
    path("list/<str:resource_category>/<int:id>/",views.list, name = "list"),
    path("card/<str:resource_category>/<int:id>/",views.card, name = "card"),
